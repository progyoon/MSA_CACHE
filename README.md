...
<!---
progyoon/progyoon is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
You can click the Preview link to take a look at your changes.
--->
](https://github.com/kirobo77/cache/blob/main/doc/cache-patterns.md
https://github.com/kirobo77/cache.git


sts실행
java -jar d:\spring-tool-suite-4-4.19.1.RELEASE-e4.28.0-win32.win32.x86_64.self-extracting.jar

lombok 실행
java -jar d:\lombok.jar

redis 실행
D:\GitHub\cache\infra\Redis-x64-3.2.100
